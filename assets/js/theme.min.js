...
var getSearch=function(/** @type {{highlightTag: string, maxResultLength: number}} */a){var b=a.highlightTag,c=a.maxResultLength;return function(a){var d=[],e=self._index.search(a);0<e.length&&!!e[0].matches&&(e.forEach(function(a){a.matches.sort(function(c,a){return c.indices[0][2]-a.indices[0][2]})}),e.sort(function(c,a){var b=c.matches[0].indices[0][2]-a.matches[0].indices[0][2];return 0==b?c.item.date===a.item.date?c.item.score-a.item.score:a.item.date.localeCompare(c.item.date):b}));for(var f=function(a){var c=e[a],f=c.item,g=c.matches,h=f.title,i=f.content,j=i.length,k=function(a,c){for(var d=0,e=0,f=0;f<c.length;f++){if(c[f][0]<e){c[f][1]>e&&(e=c[f][1]);continue}e=c[f][1];var g=a.substring(c[f][0]+d,c[f][1]+1+d),h="<".concat(b,">")+g+"</".concat(b,">");a=a.substring(0,c[f][0]+d)+h+a.substring(c[f][1]+1+d,a.length),d+=2*b.length+5}return a};g.forEach(function(a){var b=a.indices,c=a.key;"content"===c?(b[0][0]<j&&(j=b[0][0]),i=k(i,b)):"title"===c&&(h=k(h,b))}),20<j&&(i="..."+i.substr(j-15)),d.push({uri:f.uri,title:h,date:f.date,context:i})},g=0;g<Math.min(e.length,c);g++)f(g);return d}};exports.getSearch=getSearch;
